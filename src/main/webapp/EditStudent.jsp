...
<head>
    ...
    <title>Edit Student - SkillBazaar</title>
...
<body>
    ...
    <div class="container">
        ...
        if (idParam != null && !idParam.isEmpty()) {
            ...
            User u = uDao.getUserById(id); // Assumes new method added
            if (u != null && "student".equals(u.getRole())) {
        %>
        <div class="form-container">
            <% if (request.getParameter("error") != null) { %>
                <div class="error">Update failed. Please try again.</div>
            <% } %>
            <form action="adminUsersController" method="post">
                ...
                <input type="email" name="email" value="<%= u.getEmail() %>" placeholder="Email" required>
                <button type="submit">Save</button>
                <button type="button" class="cancel" onclick="window.location.href='adminUsers.jsp'">Cancel</button>
            </form>
        </div>
        <% } else { %>
